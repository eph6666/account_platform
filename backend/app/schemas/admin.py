...
class ModelConfig(BaseModel):
    ...
    enabled: bool = Field(True, description="Whether this model is enabled for quota query")
    show_in_dashboard: bool = Field(False, description="Whether to show this model in dashboard (max 2 models)")
